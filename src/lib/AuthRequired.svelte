...
<div class="flex-1 flex flex-col items-center justify-center" transition:fly={{ y: 40 }}>
    ...
    <a class="card flex gap-2 mt-4 py-3 px-5 hover:variant-soft-primary" href="https://github.com/login/oauth/authorize?client_id={PUBLIC_GITHUB_CLIENT_ID}&redirect_uri={$page.url}">
        <IconBrandGithub />
